...
<body>
  ...
  <div class="card">
    ...
    <form action="{{ route('tenants.store') }}" method="POST">
      ...
      <div class="mb-3">
        <label for="domain" class="form-label">Branches</label>
        <input type="number" class="form-control" name="branches" placeholder="Enter total branches" required>
      </div>
      <div class="mb-3">
      ...
      <button type="submit" class="btn btn-primary rounded-pill mt-3">Add</button>
    </form>
  </div>
